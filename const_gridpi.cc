...
constexpr double gridpi2(unsigned npoints)     // calculates the number of points with dist <= 1
{
...
int main()
{
    ...
    double pi = gridpi2(npoints);    // do calculation and assign output to pi for printing to user
